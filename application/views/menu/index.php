                        ...
                        <tbody>
                            ...
                            <?php foreach ($menu as $m) : ?>
                                <tr>
                                    ...
                                    <td><?= $m['menu']; ?></td>
                                    <td>
                                        <a href="" class="badge badge-success" data-toggle="modal" data-target="#editModal<?= $m['id']; ?>">Edit</a>
                                        <a onclick="return confirm('Are you sure to delete this menu?');" href="<?= base_url('menu/deleteMenu/') . $m['id']; ?>" class="badge badge-danger">Delete</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
